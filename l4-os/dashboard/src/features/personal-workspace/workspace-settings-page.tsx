        ...
        {tab === "appearance" ? (
          <section className="personal-detail-card personal-appearance-settings">
            ...
            <div className="personal-settings-choice-group" role="radiogroup" aria-label={t("settings.workspaceTheme")}>
              ...
              <button aria-checked={theme === "aios"} onClick={() => onThemeChange("aios")} role="radio" type="button">
                <span className="personal-settings-theme-swatch is-aios" />
                <strong>{t("settings.themeAios")}</strong>
                <small>{t("settings.themeAiosDescription")}</small>
              </button>
            </div>
          </section>
        ) : null}
